package com.timja.starmine.entity;
...
public class ProbeEntity extends PathfinderMob {
    public static final TagKey<Block> HARVESTABLE = BlockTags.create(StarMine.id("harvestable"));
    ...
    static class HarvestGoal extends Goal {
        ...
        public void tick() {
            ...
            level.setBlock(pos, StarMine.DEPLETED_NODE.get().defaultBlockState(), Block.UPDATE_ALL);
