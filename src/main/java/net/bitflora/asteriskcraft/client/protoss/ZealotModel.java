 ...
 * zone lit by {@link net.bitflora.asteriskcraft.client.UnitGlowLayer}). Each cube owns its own UV island; the texture is hand-painted in Blockbench via tools/blockbench_export.py.
 * Head-look plus a simple limb-swing walk are driven in setupAnim.
 */
public class ZealotModel extends EntityModel<LivingEntityRenderState> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition head = root.addOrReplaceChild("head",
                CubeListBuilder.create().texOffs(33, 0).addBox(-3.5f, -5.0f, -7.5f, 7.0f, 5.0f, 11.0f),
        ...
        head.addOrReplaceChild("visor",
                CubeListBuilder.create().texOffs(71, 19).addBox(-3.0f, -3.5f, -8.1f, 6.0f, 2.0f, 1.0f),
                PartPose.ZERO);
        ...
        body.addOrReplaceChild("skirt",
                CubeListBuilder.create().texOffs(34, 19).addBox(-5.5f, 10.0f, -3.5f, 11.0f, 4.0f, 7.0f),
                PartPose.offset(0.0f, 0.0f, 0.0f));

        // --- Arms (pivot at the shoulders, y=2) -------------------------------------------
        PartDefinition armL = body.addOrReplaceChild("armL",
                CubeListBuilder.create().texOffs(0, 19).addBox(-2.0f, -1.0f, -2.0f, 4.0f, 10.0f, 4.0f),
        ...
        armL.addOrReplaceChild("bladeL",
                CubeListBuilder.create().texOffs(104, 0).addBox(-1.0f, 0.0f, -1.0f, 2.0f, 13.0f, 2.0f),
                PartPose.offset(0.0f, 7.0f, 0.0f));
        PartDefinition armR = body.addOrReplaceChild("armR",
                CubeListBuilder.create().texOffs(17, 19).addBox(-2.0f, -1.0f, -2.0f, 4.0f, 10.0f, 4.0f),
                PartPose.offset(-6.5f, 2.0f, 0.0f));
        armR.addOrReplaceChild("bladeR",
                CubeListBuilder.create().texOffs(113, 0).addBox(-1.0f, 0.0f, -1.0f, 2.0f, 13.0f, 2.0f),
                PartPose.offset(0.0f, 7.0f, 0.0f));

        // --- Legs (pivot at the hips, y=12) -----------------------------------------------
        root.addOrReplaceChild("legL",
                CubeListBuilder.create().texOffs(70, 0).addBox(-2.0f, 0.0f, -2.0f, 4.0f, 12.0f, 4.0f),
                PartPose.offset(2.5f, 12.0f, 0.0f));
        root.addOrReplaceChild("legR",
                CubeListBuilder.create().texOffs(87, 0).addBox(-2.0f, 0.0f, -2.0f, 4.0f, 12.0f, 4.0f),
                PartPose.offset(-2.5f, 12.0f, 0.0f));
