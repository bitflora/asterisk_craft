 ...
 * Each cube owns its own UV island; the texture is hand-painted in Blockbench via tools/blockbench_export.py. It hovers and is fully static — no
 * animated parts.
 */
public class ProbeModel extends EntityModel<LivingEntityRenderState> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        // The pod floats around y=13 so it reads as hovering.
        ...
        body.addOrReplaceChild("dome",
                CubeListBuilder.create().texOffs(36, 15).addBox(-2.5f, -2.0f, -2.5f, 5.0f, 2.0f, 5.0f),
                PartPose.offset(0.0f, -3.5f, 0.0f));
        // Lower pod taper.
        body.addOrReplaceChild("underPod",
                CubeListBuilder.create().texOffs(0, 25).addBox(-2.5f, 0.0f, -2.5f, 5.0f, 2.0f, 5.0f),
                PartPose.offset(0.0f, 3.5f, 0.0f));

        // Glowing cyan sensor eye on the front.
        body.addOrReplaceChild("eye",
                CubeListBuilder.create().texOffs(42, 25).addBox(-1.5f, -1.5f, -0.5f, 3.0f, 3.0f, 1.0f),
                PartPose.offset(0.0f, -0.5f, -3.6f));

        // Three downward leg-prongs (two front, one rear).
        body.addOrReplaceChild("prongFL",
                CubeListBuilder.create().texOffs(28, 25).addBox(-0.75f, 0.0f, -0.75f, 1.5f, 5.0f, 1.5f),
                PartPose.offsetAndRotation(2.5f, 3.0f, -2.0f, 0.25f, 0.0f, 0.3f));
        body.addOrReplaceChild("prongFR",
                CubeListBuilder.create().texOffs(35, 25).addBox(-0.75f, 0.0f, -0.75f, 1.5f, 5.0f, 1.5f),
                PartPose.offsetAndRotation(-2.5f, 3.0f, -2.0f, 0.25f, 0.0f, -0.3f));
        body.addOrReplaceChild("prongB",
                CubeListBuilder.create().texOffs(21, 25).addBox(-0.75f, 0.0f, -0.75f, 1.5f, 5.0f, 1.5f),
        ...
        body.addOrReplaceChild("spikeBackC",
                CubeListBuilder.create().texOffs(29, 0).addBox(-0.75f, -0.75f, 0.0f, 1.5f, 1.5f, 8.0f),
                PartPose.offsetAndRotation(0.0f, -1.5f, 3.0f, 0.35f, 0.0f, 0.0f));
        body.addOrReplaceChild("spikeBackL",
                CubeListBuilder.create().texOffs(0, 15).addBox(-0.75f, -0.75f, 0.0f, 1.5f, 1.5f, 7.0f),
                PartPose.offsetAndRotation(2.0f, 0.5f, 3.0f, 0.5f, -0.4f, 0.0f));
        body.addOrReplaceChild("spikeBackR",
                CubeListBuilder.create().texOffs(18, 15).addBox(-0.75f, -0.75f, 0.0f, 1.5f, 1.5f, 7.0f),
                PartPose.offsetAndRotation(-2.0f, 0.5f, 3.0f, 0.5f, 0.4f, 0.0f));
