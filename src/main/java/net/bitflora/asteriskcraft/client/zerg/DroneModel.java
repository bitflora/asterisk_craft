 ...
 * small grasping fore-claws. Textured via flat colour zones (see tools/gen_drone_texture.py). It hovers
...
public class DroneModel extends EntityModel<LivingEntityRenderState> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        // SPINE/emissive = texOffs(68,0). The whole worker floats around y=15 so it reads as hovering.
        ...
        segment1.addOrReplaceChild("hump",
                CubeListBuilder.create().texOffs(0, 0).addBox(-2.5f, -3.0f, -2.0f, 5.0f, 4.0f, 6.0f),
                PartPose.offsetAndRotation(0.0f, -2.5f, 1.5f, -0.2f, 0.0f, 0.0f));
        // Two orange-glowing back spikes.
        segment1.addOrReplaceChild("spikeL",
                CubeListBuilder.create().texOffs(68, 0).addBox(-0.75f, -5.0f, -0.75f, 1.5f, 5.0f, 1.5f),
        ...
        PartDefinition head = segment1.addOrReplaceChild("head",
                CubeListBuilder.create().texOffs(0, 0).addBox(-2.5f, -2.0f, -4.0f, 5.0f, 4.0f, 4.0f),
                PartPose.offset(0.0f, 0.5f, -4.0f));
        head.addOrReplaceChild("mandibleL",
                CubeListBuilder.create().texOffs(44, 0).addBox(-0.5f, -0.5f, -3.0f, 1.0f, 1.0f, 3.0f),
                PartPose.offsetAndRotation(1.5f, 1.5f, -3.5f, 0.0f, -0.25f, 0.0f));
        head.addOrReplaceChild("mandibleR",
                CubeListBuilder.create().texOffs(44, 0).addBox(-0.5f, -0.5f, -3.0f, 1.0f, 1.0f, 3.0f),
                PartPose.offsetAndRotation(-1.5f, 1.5f, -3.5f, 0.0f, 0.25f, 0.0f));
        head.addOrReplaceChild("eye",
                CubeListBuilder.create().texOffs(68, 0).addBox(-1.5f, -0.75f, -0.5f, 3.0f, 1.5f, 1.0f),
                PartPose.offset(0.0f, -0.5f, -4.1f));

        // --- Grasping fore-claws (hang down under the front) ------------------------------
        segment1.addOrReplaceChild("clawL",
                CubeListBuilder.create().texOffs(44, 0).addBox(-0.75f, 0.0f, -1.0f, 1.5f, 5.0f, 2.0f),
        ...
        segment1.addOrReplaceChild("tail",
                CubeListBuilder.create().texOffs(0, 0).addBox(-1.5f, -1.5f, 0.0f, 3.0f, 3.0f, 5.0f),
