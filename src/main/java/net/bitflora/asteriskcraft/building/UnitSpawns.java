 ...
 * near the building, warp the unit in, tag the army it belongs to (side and race), and play the
 * teleport cue. Every place a
...
public final class UnitSpawns {
    ...
    @Nullable
    public static <T extends Mob> T spawn(ServerLevel level, BlockPos near, EntityType<T> type,
            Faction faction, Race race, boolean dyeArmor) {
        ...
        FactionAttachments.set(unit, faction, race);
        if (dyeArmor) {
